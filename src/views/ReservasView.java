...
//					registro.setVisible(true);
	...
	public void guardarReserva(){
		try{
			...
			Reserva reserva = new Reserva(java.sql.Date.valueOf(fechaE),java.sql.Date.valueOf(fechaE),txtValor.getText(),txtFormaPago.getSelectedItem().toString());
	...
	private void calcularValor(JDateChooser fechaE, JDateChooser fechaS){
		if(fechaE.getDate() != null && fechaS.getDate() != null){
			...
			int dias = -1; // para contar a partir del dia siguiente
			int diaria = 180;
			int valor;
